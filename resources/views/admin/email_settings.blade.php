                    ...
                    <form class="email-settings" method="POST">
						<div>
							...
							<select class="form-control show-tick" id="smtp_or_mail" name="smtp_or_mail">
								...
								<option value="mail" selected>Server Mail (Default)</option>
							</select>
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <input type="text" id="siteEmail" name="siteEmail" class="form-control" value="info@quickdatescript.com">
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <input type="text" id="smtp_host" name="smtp_host" class="form-control" value="quickdatescript.com">
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <input type="password" id="smtp_password" name="smtp_password" class="form-control" value="@ZE3mud2suDKfga">
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <input type="text" id="smtp_port" name="smtp_port" class="form-control" value="465">
                    ...
                    <form class="messagebird-settings" method="POST">
						...
						<div>
							...
							<div class="form-group float-right switcher">
								...
								<input type="checkbox" name="messagebird_provider" id="messagebird_provider-enabled" value="1" >
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <input type="text" id="messagebird_key" name="messagebird_key" class="form-control" value="">
                            </div>
                        </div>
                        <div class="form-group form-float">
                            <div class="form-line">
                                <label class="form-label">MessageBird Phone Number</label>
                                <input type="text" id="messagebird_phone" name="messagebird_phone" class="form-control" value="">
                            </div>
                        </div>
                    ...
                    <form class="infobip-settings" method="POST">
						...
						<div>
							...
							<div class="form-group float-right switcher">
								...
								<input type="checkbox" name="infobip_provider" id="infobip_provider-enabled" value="1" >
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <input type="text" id="infobip_username" name="infobip_username" class="form-control" value="">
                            </div>
                        </div>
                        <div class="form-group form-float">
                            <div class="form-line">
                                <label class="form-label">Infobip Password</label>
                                <input type="text" id="infobip_password" name="infobip_password" class="form-control" value="">
                            </div>
                        </div>
                        <div class="form-group form-float">
                            <div class="form-line">
                                <label class="form-label">Infobip Phone Number</label>
                                <input type="text" id="infobip_phone_number" name="infobip_phone_number" class="form-control" value="">
                            </div>
                        </div>
                    ...
                    <form class="sms-settings" method="POST">
						...
						<div>
							...
							<div class="form-group float-right switcher">
								...
								<input type="checkbox" name="twilio_provider" id="twilio_provider-enabled" value="1" >
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <input type="text" id="sms_t_phone_number" name="sms_t_phone_number" class="form-control" value="+18572148349">
                            </div>
                        </div>
                        <div class="form-group form-float">
                            <div class="form-line">
                                <label class="form-label">Your Phone number <small>e.g (+9053..)</small></label>
                                <input type="text" id="sms_phone_number" name="sms_phone_number" class="form-control" value="">
                            </div>
                        </div>
                    ...
                    <form class="bulksms-settings" method="POST">
						...
						<div>
							...
							<div class="form-group float-right switcher">
								...
								<input type="checkbox" name="bulksms_provider" id="bulksms_provider-enabled" value="1" >
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <input type="text" id="bulksms_username" name="bulksms_username" class="form-control" value="">
                            </div>
                        </div>
                        <div class="form-group form-float">
                            <div class="form-line">
                                <label class="form-label">BulkSMS Password</label>
                                <input type="text" id="bulksms_password" name="bulksms_password" class="form-control" value="">
                            </div>
                        </div>
                        <div class="form-group form-float">
                            <div class="form-line">
                                <label class="form-label">BulkSMS Phone number</label>
                                <input type="text" id="bulksms_phone_number" name="bulksms_phone_number" class="form-control" value="">
                            </div>
                        </div>
						<div class="alert alert-info">After clicking "Test SMS Server", a test message will be sent to your phone</div>
                        <p class="help-block" style="color:red;">Please save the form before testing the server.</p>
                    ...
                    <form class="msg91-settings" method="POST">
						...
						<div>
							...
							<div class="form-group float-right switcher">
								...
								<input type="checkbox" name="msg91_provider" id="msg91_provider-enabled" value="1" >
                        ...
                        <div class="form-group form-float">
                            <div class="form-line">
                                ...
                                <input type="text" id="msg91_authKey" name="msg91_authKey" class="form-control" value="">
                            </div>
                        </div>
                        <div class="form-group form-float">
                            <div class="form-line">
                                <label class="form-label">Msg91 DLT ID</label>
                                <input type="text" id="msg91_dlt_id" name="msg91_dlt_id" class="form-control" value="">
                            </div>
                        </div>
                        <div class="form-group form-float">
                            <div class="form-line">
                                <label class="form-label">Msg91 Phone number</label>
                                <input type="text" id="msg91_phone_number" name="msg91_phone_number" class="form-control" value="">
                            </div>
                        </div>
