                    ...
                    <li class="nav-item mr-3">
                        <div class="header-search-form">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Search"  onkeyup="">
                                        ...
                                        <li class="px-4 py-3 list-group-item">
                                            <a href="" class="d-flex align-items-center hide-show-toggler">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <span class="text-muted small">20/12/2020</span>
                                                </div>
                                            </a>
                                        </li>
                                        ...
                                        <li class="px-4 py-3 list-group-item">
                                            <a href="" class="d-flex align-items-center hide-show-toggler">
                                                ...
                                                <div class="flex-grow-1">
                                                    ...
                                                    <span class="text-muted small">20/20/1220</span>
                                                </div>
                                            </a>
                                        </li>
                                </ul>
                            ...
                            <div class="px-4 py-3 text-right border-top">
                                <ul class="list-inline small">
                                    <li class="list-inline-item mb-0">
                                        <a href="javascript:void(0)" onclick="">Mark All Read</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-big">
                            <div class="text-center py-4">
                                ...
                                <h5 class="text-center">jamiu</h5>
                                <div class="mb-3 small text-center text-muted">jamiu@gmail.com</div>
                                <a href="" class="btn btn-outline-light btn-rounded">View Profile</a>
                            </div>
                            <div class="list-group">
                                <a href="javascript:void(0)" onclick="" class="list-group-item text-danger">Sign Out!</a>
                                    <a href="javascript:void(0)" class="list-group-item admin_mode" onclick="">
