    ...
    <div class="dt_left_sidebar">
        <div class="home_usr_sct">
            <div>
                <div class="user_popularity_icn" data-value="">
                    ...
                    <a class="avatar" href={{"/@" . $user->username}} data-ajax=""><img style="object-fit:cover" src={{$user->avatar ?? "/img/icon.png"}} class="circle" alt="" /></a>
                </div>
                <span>
        ...
        <ul class="menu">
            ...
            <li>
                ...
                <li>
                    <a href="/logOut">
                        <i style="margin-right: 2em" class="fa-solid fa-right-from-bracket"></i> <?php echo __( 'Log Out' );?>
                    </a>
                </li>
        </ul>
    </div>
