<!-- Footer  -->
<footer id="footer" class="page_footer" style="font-size: 14px">
    <div class="container-fluid container_new">
        <div class="footer-copyright">
            <div class="valign-wrapper">
                    ...
                    <div id="modal_langs" class="modal modal-sm" tabindex="0">
                        <div class="modal-content">
                            ...
                            <ul class="browser-default dt_lang_modal">
                                <li><a href=""><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="currentColor" d="M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z" /></svg> </a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <ul class="dt_footer_links mt-3">
                    <li><a href="/about" data-ajax="/about"><?php echo __( 'About Us' );?></a></li>
                    &nbsp;-&nbsp;<li><a href="/terms" data-ajax="/terms"><?php echo __( 'Terms' );?></a></li>
                ...
                <div><?php echo __( 'Copyright' );?> © <?php echo date( "Y" ) . " Admyrer";?>. <?php echo __( 'All rights reserved' );?>.</div>
            </div>
        </div>
    </div>
</footer>
