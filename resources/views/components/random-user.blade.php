            ...
            <div class="card valign-wrapper" style="border: none !important">
                ...
                <div class="card-content">
                    ...
                    <div class="rand_bottom_bar">
                        <button  onclick="like('{{$user->first_name}}', 'rand')" class="btn waves-effect like" id="like_btn" data-userid="" data-ajax-post="/useractions/like" data-ajax-params="userid=>&username=" data-ajax-callback="callback_like">
                        ...
                        <button  onclick="dislike('{{$user->first_name}}', 'rand')" class="btn waves-effect dislike _dislike_text" data-userid="" id="dislike_btn" data-ajax-post="/useractions/dislike" data-ajax-params="userid" data-ajax-callback="callback_dislike">
