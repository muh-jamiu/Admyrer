...
@section('title')
Admyrer | Meet new and interesting people
@endsection
	...
	<div class="main_header_nav">
		<nav role="navigation">
			<div class="nav-wrapper">
				...
				<ul class="right not_usr_nav text-center" style="width: fit-content; position: absolute;right:0; top:0">
					<li><a href="/login" data-ajax="/login" class="btn btn-flat"><?php echo __( 'Login' );?></a></li>
						<li><a href="/register" data-ajax="/register" class="btn-flat btn waves-effect"><?php echo __( 'Register' );?></a></li>
				</ul>
			</div>
		</nav>
		...
		<div class="section mt-5 header_bg">
			...
			<div class="home_pz_rel">
				...
				<h5 style="font-size: 1.8em"><?php echo __( 'Join' );?>, <?php echo __( 'where you could meet anyone, anywhere!' );?></h5>
				...
				<div class="section dt_hdr_filters homa">
					...
					<div>
						<a href="/login" class="btn btn-large waves-effect waves-light bold btn_primary btn_round"><?php echo __( 'Let\'s Begin Finding Matches' );?></a>
					</div>
				</div>
		...
		<div class="row">
			...
			<div class="col l6">
				<div class="dt_header_how_works_innr flip">
					<h2 class="mx-3"><?php echo __( 'Why Quickdate is the best platform?' );?></h2>
					<p class="mx-3"><?php echo __( 'Quickdate, where you could meet anyone digitally! It\'s a complete fun to find a perfect match for you and continue to hook up. Real time messaging & lot of features that keeps you connected with your love 24x365 days.' );?></p>
				</div>
			</div>
		</div>
			...
			<div class="top">
				<div class="row">
					<div class="col-sm-4">
						...
						<div class="row">
							<div class="col s6">
								<div><a href="/about" data-ajax="/about"><?php echo __( 'About Us' );?></a></div>
								<div><a href="/terms" data-ajax="/terms"><?php echo __( 'Terms and Conditions' );?></a></div>
								<div><a href="/privacy" data-ajax="/privacy"><?php echo __( 'Privacy Policy' );?></a></div>
								<div><a href="/contact" data-ajax="/contact"><?php echo __( 'Contact' );?></a></div>
							</div>
							<div class="col s6">
