		...
		<div class="col-sm-9">
			...
			<div class="container-fluid dt_ltst_users">
				<div class="dt_home_rand_user">
					<h6 class="bold mb-3"><?php echo __( 'People i Disliked' );?></h6>
									...
									<div class="card valign-wrapper" style="border: none !important">
										...
										<div class="card-content">
											...
											<div class="rand_bottom_bar">
												<button onclick="DisLike({{$likeUser->id}}, {{$key}}, '{{$likeUser->first_name}}')" id="like_btn" class="btn waves-effect like liked" data-ajax-post="/useractions/remove_like" data-ajax-params="userid=" data-ajax-callback="callback_liked_remove_like">
...
<script>
	...
	function DisLike(like, index, name){
