...
<div class="container container-fluid container_new page-margin find_matches_cont">
    {{-- <div class="home-announcement">
        <div class="alert alert-success" style="background-color: white;">
            <span class="close announcements-option" data-toggle="tooltip" onclick="Wo_ViewAnnouncement();" title="<?php echo __('Hide');?>" style="float: right;cursor: pointer;">
						...
						<div class="col-sm-4 m6 s12 random_user_item">
							<div class="card valign-wrapper">
								...
								<div class="card-content">
									<a style="font-size: 12px" href="" class="d-block mb-2 fw-bold text-capitalize" data-ajax="/"><span class="card-title">jamiu ganiu</span></a>
									<p>24 nigeria</p>
									<p>male</p>
