...
<div class="container container-fluid container_new page-margin find_matches_cont">
	...
	<div class="row r_margin">
        ...
        {{-- sidiebar --}}
        <x-dashboard-sidebar :user="$user" :groupactive="true"></x-dashboard-sidebar>		

		<div class="col-sm-9">
			<!-- People i liked  -->
			<div class="container-fluid dt_ltst_users">
				<div class="dt_home_rand_user">
					<h6 class="bold mb-4"><?php echo __( "Select one or more users you'll like to go on group date with." );?></h6>
                    <p data-bs-toggle="modal" data-bs-target="#__web__" id="_sendReq" class="bg-success _sendReq d-none px-2 py-1 text-white rounded" style="width: fit-content; font-size:12px">Start Group Date With Selected Users</p>
...
<div class="modal fade" id="__web__">
    <div class="modal-dialog modal-dialog-centered modal-l">
        ...
        <div class="modal-header">
            <h6 class="modal-title text-capitalize">Start Group Date</h6>
            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
        </div>
    
        <!-- Modal body -->
        <div class="modal-body">
            <p style="font-size: 10px" class="text-danger">These are the list of users that will recieve notification and get to join your group date.</p>
            <div id="listin_" class="listin_"></div>
    
            <button onclick="sendReq()" data-bs-dismiss="modal" class="btn btn-danger mt-2 mb-3">Start</button>
            <p style="font-size: 10px">Users you sent request will be able to join your group date.</p>
        </div>
