...
@php
	$user = $data["user"] ?? [];
	$personalLikes = $data["personalLikes"] ?? [];
@endphp
...
<div class="container container-fluid container_new page-margin find_matches_cont">
	...
	<div class="row r_margin">
        ...
        {{-- sidiebar --}}
        <x-dashboard-sidebar :user="$user" :likesactive="true"></x-dashboard-sidebar>			
		...
		<div class="col-sm-9">
			...
			<div class="container-fluid dt_ltst_users">
				<div class="dt_home_rand_user">
					...
					@if (count($personalLikes) > 0)
						<div class="row" id="liked_users_container">
							@foreach ($personalLikes as $key => $likeUser)					
