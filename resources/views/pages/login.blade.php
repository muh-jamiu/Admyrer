							...
							<form method="POST" action="/login" class="login">
								...
								<div class="row">
									<div class="input-field">
										...
										<label for="password" class="mx-2"><?php echo __( 'Password' );?></label>
									</div>
								</div>
